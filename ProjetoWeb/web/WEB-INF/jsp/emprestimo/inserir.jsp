...
<html>
    ...
    <body>
        ...
        <form method="POST" action="${pageContext.request.contextPath}/emprestimo!inserir.action">
            <label for="IDAutor">ID do Autor:&nbsp;</label>
            <input type="text" name="IDAutor" size="10"/>

            <br><br>
            
            <label for="IDLivro">ID do Livro:&nbsp;</label>
            <input type="text" name="IDLivro" size="10"/>

            <br><br>

            <label for="IDTipoUsuario">ID do Tipo de Usuário:&nbsp;</label>
            <input type="text" name="IDTipoUsuario" size="10"/>
            
            <br><br>

            <label for="IDUsuario">ID do Usuário:&nbsp;</label>
            <input type="text" name="IDUsuario" size="10"/>
