...
VALUES('Valdemar de Melo Neves Junior','valneves','123',1);

INSERT
INTO PROJETO.USUARIO(NOME_USUARIO, LOGIN_USUARIO, SENHA_USUARIO, ID_TIPO_USUARIO)
VALUES('Patrick Gainher','patgainher','123',1);

INSERT
INTO PROJETO.USUARIO(NOME_USUARIO, LOGIN_USUARIO, SENHA_USUARIO, ID_TIPO_USUARIO)
VALUES('Pedro Henrique Cacique Braga','cacique','123',1);
...
INSERT
INTO PROJETO.USUARIO(NOME_USUARIO, LOGIN_USUARIO, SENHA_USUARIO, ID_TIPO_USUARIO)
VALUES('Administrador Geral','admin','admin',2);
...
SELECT U.ID_USUARIO, U.NOME_USUARIO, T.NOME_TIPO_USUARIO, L.NOME_LIVRO, A.NOME_AUTOR, E.DATA_EMPRESTIMO
FROM PROJETO.USUARIO U
INNER JOIN PROJETO.EMPRESTIMO E
ON U.ID_USUARIO=E.ID_USUARIO
INNER JOIN PROJETO.TIPO_USUARIO T
